package com.charles.trace.instrument.jar;

import com.charles.trace.instrument.annotation.Fox;
...
public class PerformMonitorTransformer implements ClassFileTransformer {
    ...
    static {
        // 直接定位
        classNameSet.add("com.charles.trace.instrument.client.HelloService");
        // 间接定位   注解  继承关系
    }
