...
public class ReturnListenerProducer {
    ...
    public static String alternateExchangeName = "ALTERNATE_EXCHANGE";

    public static String alternateQueueName = "ALTERNATE_EXCHANGE";

    public static String alternateRoutingKey = "#";

    public static String testExchangeName1 = "testExchangeName1";

    public static String testExchangeName2 = "testExchangeName2";

    public static String testRoutingKey = "testRoutingKey";
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 声明一个备份交换机
        channel.exchangeDeclare(alternateExchangeName, "topic", false, false, false, null);
        channel.queueDeclare(alternateQueueName, false, false, false, null);
        channel.queueBind(alternateExchangeName, alternateExchangeName, alternateRoutingKey);
        // 在声明交换机的时候指定备份交换机
        ...
        channel.exchangeDeclare(testExchangeName2,"topic", false, false, false, null);
